 ...
 * 
 */
package com.hitech.dms.web.controller.activity.permission;
...
import com.hitech.dms.web.dao.activity.permission.ActivityPermissionCheckDao;
...
public class ActivityPermissionCheckController {
	private static final Logger logger = LoggerFactory.getLogger(ActivityPermissionCheckController.class);

	@Autowired
	private ActivityPermissionCheckDao activityPermissionCheckDao;
	...
	public ResponseEntity<?> checkActivityApprovalPermissions(@RequestBody ActivityPermissionRequestModel requestModel,
		...
		Map<String, Object> responseModel = activityPermissionCheckDao.checkActivityPermissions(userCode, requestModel);
