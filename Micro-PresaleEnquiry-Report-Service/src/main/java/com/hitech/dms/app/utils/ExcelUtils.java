...
//                    logger.debug(value+" : columnCount : "+columnCount+" : rowCount : "+rowCount);
	...
	public static <T> EnquiryExportResponseModel createExcelInMultiSheets(final String filePath, String fileName,
			final String sheetName, final String fertCode, String header, final List<T> data, String isFor) {
		File file = null;
		...
		List<String> fieldNames = null;
		Font font = null;
		EnquiryExportResponseModel responseModel = new EnquiryExportResponseModel();
...
//                   logger.debug(value+" : columnCount : "+columnCount+" : rowCount : "+rowCount);
	...
	private static String resetFieldsName(String fieldName) {
		...
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.EXPECTED_PURCHASE_DATE.getPropertyName())) {
			fieldName = ModalPropertyEnum.EXPECTED_PURCHASE_DATE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.NEXT_FOLLOWUP_DATE.getPropertyName())) {
			fieldName = ModalPropertyEnum.NEXT_FOLLOWUP_DATE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.NEXT_FOLLOWUP_ACTIVITY.getPropertyName())) {
			fieldName = ModalPropertyEnum.NEXT_FOLLOWUP_ACTIVITY.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.CASH_LOAN.getPropertyName())) {
			fieldName = ModalPropertyEnum.CASH_LOAN.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.FINANCIER_NAME.getPropertyName())) {
			fieldName = ModalPropertyEnum.FINANCIER_NAME.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.FINANCIER_LOGGED_DATE.getPropertyName())) {
			fieldName = ModalPropertyEnum.FINANCIER_LOGGED_DATE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.LOAN_AMOUNT_APPLIED.getPropertyName())) {
			fieldName = ModalPropertyEnum.LOAN_AMOUNT_APPLIED.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.TENURE_MONTH.getPropertyName())) {
			fieldName = ModalPropertyEnum.TENURE_MONTH.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.RATE_OF_INTEREST.getPropertyName())) {
			fieldName = ModalPropertyEnum.RATE_OF_INTEREST.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.EMI_AMOUNT.getPropertyName())) {
			fieldName = ModalPropertyEnum.EMI_AMOUNT.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.RETAIL_FINANCE_STATUS.getPropertyName())) {
			fieldName = ModalPropertyEnum.RETAIL_FINANCE_STATUS.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.DISBURSED_DATE.getPropertyName())) {
			fieldName = ModalPropertyEnum.DISBURSED_DATE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.SUBSIDY.getPropertyName())) {
			fieldName = ModalPropertyEnum.SUBSIDY.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.SUBSIDY_AMOUNT.getPropertyName())) {
			fieldName = ModalPropertyEnum.SUBSIDY_AMOUNT.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.EXCHANGE_BRAND.getPropertyName())) {
			fieldName = ModalPropertyEnum.EXCHANGE_BRAND.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.EXCHANGE_MODEL.getPropertyName())) {
			fieldName = ModalPropertyEnum.EXCHANGE_MODEL.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.EXCHANGE_YEAR.getPropertyName())) {
			fieldName = ModalPropertyEnum.EXCHANGE_YEAR.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.DEAL_VALUE.getPropertyName())) {
			fieldName = ModalPropertyEnum.DEAL_VALUE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.TOTAL_AMOUNT_RECEIVED.getPropertyName())) {
			fieldName = ModalPropertyEnum.TOTAL_AMOUNT_RECEIVED.getDescp();
		...
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.BRANCHCODE.getPropertyName())) {
			fieldName = ModalPropertyEnum.BRANCHCODE.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.BRANCHNAME.getPropertyName())) {
			fieldName = ModalPropertyEnum.BRANCHNAME.getDescp();
		} else if (fieldName.equalsIgnoreCase(ModalPropertyEnum.BRANCHLOCATION.getPropertyName())) {
			fieldName = ModalPropertyEnum.BRANCHLOCATION.getDescp();
		}
