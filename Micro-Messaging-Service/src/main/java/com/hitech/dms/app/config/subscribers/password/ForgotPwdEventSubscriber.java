 ...
 *
 */
public class ForgotPwdEventSubscriber extends StringToObjectModel {
	private Logger logger = LoggerFactory.getLogger(ForgotPwdEventSubscriber.class);
	...
	public ForgotPwdEventSubscriber(MsgLogService msgLogService, SmsMailDao smsMailDao, MailUtil mailUtil,
	...
	public void receive(String msg) {
		...
		if (publishModel != null) {
			logger.info("Forgot Password received message '{}'", publishModel.toString());
	...
	private void updateMsgLogData(MailWithTemplate mail, int msgLogStatus, SmsMailRequestModel requestModel,
		...
		MsgLog msgLog = new MsgLog(msgId.toString(), mail, RabbitConfig.mail_forgot_password_exchange,
				RabbitConfig.mail_forgot_password_routing_key);
