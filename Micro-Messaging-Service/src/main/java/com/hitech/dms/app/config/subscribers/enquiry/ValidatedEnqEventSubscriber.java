 ...
 *
 */
public class ValidatedEnqEventSubscriber extends StringToObjectModel {
	...
	public ValidatedEnqEventSubscriber(MsgLogService msgLogService, SmsMailDao smsMailDao, MailUtil mailUtil,
	...
	public void receive(String msg) {
		...
		if (publishModel != null) {
			logger.info("Validated Enquiry received message '{}'", publishModel.toString());
	...
	private void updateMsgLogData(MailWithTemplate mail, int msgLogStatus, SmsMailRequestModel requestModel,
		...
		MsgLog msgLog = new MsgLog(msgId.toString(), mail, RabbitConfig.mail_validatedenq_exchange,
				RabbitConfig.mail_validatedenq_routing_key);
