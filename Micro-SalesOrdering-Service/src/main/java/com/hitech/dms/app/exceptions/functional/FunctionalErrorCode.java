...
public enum FunctionalErrorCode {
	...
	NOT_FOUND_ENTITY_VALUE(1, HttpStatus.NOT_FOUND,
			"No record of type %s and with value : %s is present in the database"),
	...
	UNAUTHORIZED_SEGMENT_TIME(35, HttpStatus.BAD_REQUEST,
			"You don't have rights to make Segments/Propositions at this time"),
	...
	AFFECTATION_ALREADY_EXIST(40, HttpStatus.BAD_REQUEST,
			"Affectation with centre gestion %s and country %s and marque %s already exist."),
	UNAUTHORIZED_PROPOSITION_VALID(41, HttpStatus.BAD_REQUEST,
			"You cannot validatee a proposition when it has expired"),
