 ...
 */
//@Component
public class ReportExporterConfig {
	private static final Logger logger = LoggerFactory.getLogger(ReportExporterConfig.class);

	private JasperPrint jasperPrint;

	public ReportExporterConfig() {
	}

	public ReportExporterConfig(JasperPrint jasperPrint) {
	...
	public void exportToPdf(String fileName, String author) {
		...
		try {
			...
			logger.error(ReportExporterConfig.class.getName(), ex);
		}
	}
