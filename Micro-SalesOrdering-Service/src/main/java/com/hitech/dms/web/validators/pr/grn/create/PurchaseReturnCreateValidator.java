 ...
 * 
 */
package com.hitech.dms.web.validators.pr.grn.create;
 ...
 */
@Component
public class PurchaseReturnCreateValidator implements Validator {
	private static final Logger logger = LoggerFactory.getLogger(PurchaseReturnCreateValidator.class);

	@Override
	public boolean supports(Class<?> clazz) {
		return PurchaseReturnCreateRequestModel.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {
		PurchaseReturnCreateRequestModel requestModel = (PurchaseReturnCreateRequestModel) target;
		...
		if (requestModel.getGrnId() == null || requestModel.getGrnId().compareTo(BigInteger.ZERO) == 0) {
			errors.reject("grnId", "Grn Number is required.");
		}
