...
@Getter
@Setter
public class PrDtlFornvoiceResponseModel {
	...
	private List<PrMachDtlViewResponseModel> salesMachineGrnDtlList;
	private List<PrItemDtlViewResponseModel> salesMachineGrnImplDtlList;
}
