 ...
 * 
 */
package com.hitech.dms.app.filter.request;
...
public final class HttpRequestResponseUtils {
	...
	public static String getEventType() {
		...
		return eventType != null ? eventType : request.getHeader("Event_Type");
	}
	...
	public static String getPageName() {
		...
		return (pageName != null ? pageName : request.getHeader("Page_Name"));
	}
	...
	public static String getLatitude() {
		...
		return (latitude != null ? latitude : request.getHeader("Lat"));
	}
	...
	public static String getLongitude() {
		...
		return (longitude != null ? longitude : request.getHeader("Lon"));
	}
	...
	public static String getLoggedInUser() {
		...
		if (SecurityContextHolder.getContext().getAuthentication() != null
			...
			userJson = (String) SecurityContextHolder.getContext().getAuthentication().getPrincipal();

			ObjectMapper mapper = new ObjectMapper();

			try {
				userJson = mapper.writeValueAsString(userJson.replaceAll("\"", ""));
