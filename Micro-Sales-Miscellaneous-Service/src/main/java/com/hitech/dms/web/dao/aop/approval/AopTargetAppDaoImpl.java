 ...
 */
@Repository
public class AopTargetAppDaoImpl implements AopTargetAppDao {
	private static final Logger logger = LoggerFactory.getLogger(AopTargetAppDaoImpl.class);
	...
	public AopTargetAppResponseModel approveRejectAopTarget(String userCode, AopTargetAppRequestModel requestModel, Device device) {
		...
		AopTargetAppResponseModel responseModel = new AopTargetAppResponseModel();
		boolean isSuccess = true;
		String sqlQuery = "exec [SP_SA_MIS_AOP_TARGET_APPROVAL] :userCode, :hoUserId, :aopId, :approvalStatus, :remark";
		try {
