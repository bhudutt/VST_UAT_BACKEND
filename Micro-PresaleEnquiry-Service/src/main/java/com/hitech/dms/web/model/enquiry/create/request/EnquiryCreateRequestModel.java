 ...
 */
@Data
public class EnquiryCreateRequestModel {
	// EnquiryMapId
	...
	private List<EnquiryFollowupRequestModel> enquiryFollowUpList;
	private List<EnquiryExchangeDTLRequestModel> enquiryExchangeDTLList;
	private List<EnquiryCustSoilTypeRequestModel> enquiryCustSoilTypeList;
	private List<EnquiryCustFleetDTLRequestModel> enquiryCustFleetDTLList;
	private List<EnquiryCustCropRequestModel> enquiryCustCropList;
	private List<EnquiryAttachImagesRequestModel> enquiryAttachImgsList;
	private CustomerHDRRequestModel customerHDRRequestModel;
