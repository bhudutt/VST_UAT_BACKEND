...
public class IndexController {
	...
	public IndexController(ApprovalStore approvalStore, TokenStore tokenStore) {
		this.approvalStore = approvalStore;
		this.tokenStore = tokenStore;
	}

	// public IndexController(JdbcClientDetailsService clientDetailsService,
	...
	// .map(clientDetail -> approvalStore.getApprovals(principal.getName(),
