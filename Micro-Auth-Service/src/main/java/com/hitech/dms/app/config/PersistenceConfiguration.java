...
public class PersistenceConfiguration {
	...
	@Autowired
	public HibernateTransactionManager transactionManagerForReports(@Qualifier("sessionFactoryForReports") SessionFactory sessionFactoryForReports) {
	...
	public SessionFactory sessionFactoryForReports(@Qualifier("dataSourceForReports") DataSource dataSourceForReports) {
		LocalSessionFactoryBuilder localSessionFactoryBuilderForReports = new LocalSessionFactoryBuilder(dataSourceForReports);
