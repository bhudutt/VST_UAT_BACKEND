...
public class CommonDaoImpl implements CommonDao {
	...
	public List<ServiceSourceEntity> fetchServiceSource(Session session, String userCode) {
		List<ServiceSourceEntity> serviceSourcelist = new ArrayList<>();
		try {
			serviceSourcelist = session.createQuery("from ServiceSourceEntity where activeStatus=:status ")
