...
@Data
@Entity
@Table(name = "PA_Dealer_Distributor_Mapping")
public class DealerDistributorMappingEntity implements Serializable {
	...
	@Column(name="Mapping_To_Dealer")
	private BigInteger mappingToDealer;
