...
public class ForgotPasswordEventPublisher {
	private Logger logger = LoggerFactory.getLogger(ForgotPasswordEventPublisher.class);
	  ...
	  private static List<String> ROUTING_KEYS = Arrays.asList(
	          "forgotpassword.created");

	  private Random random = new Random();

	  @Autowired
	  public ForgotPasswordEventPublisher(RabbitTemplate rabbitTemplate, TopicExchange topicExchange) {
