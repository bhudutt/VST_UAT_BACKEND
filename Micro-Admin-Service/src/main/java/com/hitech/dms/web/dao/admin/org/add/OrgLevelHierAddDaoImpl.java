 ...
 */
@Repository
public class OrgLevelHierAddDaoImpl implements OrgLevelHierAddDao {
	private static final Logger logger = LoggerFactory.getLogger(OrgLevelHierAddDaoImpl.class);
