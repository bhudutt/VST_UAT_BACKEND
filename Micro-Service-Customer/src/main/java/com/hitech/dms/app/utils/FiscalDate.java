...
public class FiscalDate {
	...
	public static Map<String, Object> displayFinancialDate(Calendar calendar) {
		...
		System.out.println(" ");
		mapData.put("CurrentDate", fiscalDate);
		mapData.put("FiscalYears", year + "-" + (year + 1));
		mapData.put("FiscalMonth", fiscalDate.getFiscalMonth());
		return mapData;
	}
