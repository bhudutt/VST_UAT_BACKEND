...
//	        date = calendar.getTime();
	...
	public static Map<String, Object> getDayMonthYear() {
...
//		System.out.println("Year: " + year);
		...
		mapData.put("MonthValue", currentDate.getMonthValue());
		mapData.put("nextMonth", nextMonthDate.getMonth());
		mapData.put("nextMonthValue", nextMonthDate.getMonthValue());
	...
	public static void main(String[] args) {
		System.out.println(getDayMonthYear());
	}
}
